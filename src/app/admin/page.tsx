  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-ink px-6 text-paper">
      <section className="w-full max-w-lg border border-white/10 bg-panel p-8 sm:p-10">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-coral">RegDesk / Admin</p>
        <h1 className="mt-4 text-3xl font-black tracking-tight">Admin console</h1>
        <p className="mt-4 leading-7 text-muted">Authentication and participant operations arrive in the next implementation phase.</p>
